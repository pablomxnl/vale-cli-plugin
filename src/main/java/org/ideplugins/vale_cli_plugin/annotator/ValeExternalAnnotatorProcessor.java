...
public class ValeExternalAnnotatorProcessor extends ExternalAnnotator<InitialAnnotatorInfo, AnnotatorResult> implements DumbAware {
    ...
    public @Nullable InitialAnnotatorInfo collectInformation(@NotNull PsiFile psiFile) {
        ...
        LOGGER.debug("collectInformation %s".formatted(psiFile.getName()));
