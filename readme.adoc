...
[source]
----
docker run --rm --env-file .env.empty -u gradle -v "$PWD":/home/gradle/project -w /home/gradle/project registry.gitlab.com/pablomxnl/vale-cli-plugin/builder:0.0.27 gradle test
----
