...
=== 0.0.36
- Fixes https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/65[#65] Do not perform a synchronous refresh under read lock
- Fixes https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/66[#66] java.lang.ClassNotFoundException: ini4idea.lang.psi.IniProperty

=== 0.0.35
- Implements https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/58[#58] Autocompletion and navigation to rules from .vale.ini files

=== 0.0.34
- Adjust dark mode plugin tool window icon
- Implements https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/64[#64] Navigate to vale configuration file

=== 0.0.33
- Implements https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/57[#57] Integration of documentation for vale configuration and rules

=== 0.0.32
- Implements https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/62[#62] Store project-specific vale settings in sharable .idea folder
- Implements https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/60[#60] Option to disable restriction to file extensions
- Fixes https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/55[#55] Issue detecting vale in pyenv shims

=== 0.0.31
- Fixes https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/61[#61] Do not run vale if there is no vale config available

=== 0.0.30
- Fixes https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/56[#56] PluginException: Access is allowed from Event Dispatch Thread (EDT)
- Implements https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/59[#59] Improve quick fixes


=== 0.0.29

- Fixes https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/52[#52] java.io.IOException: The pipe has been ended.
- Fixes https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/53[#53] IllegalStateException: This method is forbidden on EDT
- Implements https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/54[#54] Use path for stdin vale processing
...
- Fixes https://gitlab.com/pablomxnl/vale-cli-plugin/-/issues/49[#49] Error when no vale configuration file is found
